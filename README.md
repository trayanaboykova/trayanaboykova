...
| **MVC Project** | *In this project, I developed the database layer for an MVC web application called NLT. The application supports importing data from XML files (Companies, Projects, Employees) and exporting results such as finished projects and employees over 25 years old. The database includes three main entities: Company, Project, and Employee, with properly defined relationships (one-to-many and many-to-one). Data import handles errors by ignoring incorrect entries and printing appropriate messages. The export functionality retrieves complex queries from the database for display. This project was part of my learning at [SoftUni](https://softuni.bg/) from Spring Data.* | [MVC Project](https://github.com/trayanaboykova/Spring-Data/tree/main/MVC_Project) | [![Java](https://skillicons.dev/icons?i=java&theme=light)](https://www.java.com/en/) [![Spring](https://skillicons.dev/icons?i=spring&theme=light)](https://spring.io/) |
